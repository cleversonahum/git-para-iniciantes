<div>
  ...
  <p align="justify">Outros SVCs como Subversion, Perforce e Bazaar, pensam nas informações como um grupo de arquivos e suas alterações ao longo do tempo (baseado em deltas). Já o Git pensa na informação como um conjunto de snapshots, cada alteração confirmada gera uma imagem de um determinado arquivo.</p>


  <h3 align="left">Deltas:</h3>
  <img src="img/whatis/delta.png" style="background:none; border:none; box-shadow:none;" height="60%" width="60%"/>
  <h3 align="left">Snapshots:</h3>
  <img src="img/whatis/snapshot.png" style="background:none; border:none; box-shadow:none;" height="60%" width="60%"/>
